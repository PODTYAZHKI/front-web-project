        ...
        <div>
          <div>
            <v-card flat color="transparent">
              <v-img
                :src="this.$store.state.posts_sample[postId-1].image"
                :aspect-ratio="16 / 9"
              ...
              <v-card-text>
                <div>
                  <v-btn color="accent">{{this.$store.state.posts_sample[postId-1].category}}</v-btn>
                </div>

                <div class="text-h4 font-weight-bold primary--text pt-4 mb-2">
                  <h4>{{this.$store.state.posts_sample[postId-1].title}}</h4>
                </div>

                <div class="text-body-1 py-4" v-if="this.$store.state.posts_sample[postId-1].subtitle">
                  {{this.$store.state.posts_sample[postId-1].subtitle}}
                </div>
                ...
                <div class="d-flex align-center justify-space-between">
                  <div class="d-flex align-center">
                    ...
                    <div class="pl-2 text-body-1">Иван Иванов · 22 Июля 2019</div>
                  </div>
                  ...
                  <div>
                    <v-row>
                      <v-col class="flex-shrink-0" cols="auto">
                        <v-chip color="accent">#Животные</v-chip>
                      </v-col>

                      <v-col class="flex-shrink-0" cols="auto">
                        <v-chip color="accent">#Путешествия</v-chip>
                      </v-col>

                      <v-col class="flex-shrink-0" cols="auto">
                        <v-chip color="accent">#Птицы</v-chip>
                      </v-col>
                    </v-row>
                  </div>
